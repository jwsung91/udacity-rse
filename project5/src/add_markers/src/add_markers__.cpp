...
int main( int argc, char** argv )
{
  ...
  while (ros::ok())
  {
    ...
    while(!reach_goal)
    {
      ...
      dist_x = fabs(goals[goal_flag][0]-current_pose.x);
      dist_y = fabs(goals[goal_flag][1]-current_pose.y);
    ...
    switch (phase)
    {
        case 1:
            ...
            goal_flag = 0;
            marker.pose.position.x = goals[goal_flag][0];
            marker.pose.position.y = goals[goal_flag][1];
        ...
        case 2:
            ROS_INFO_ONCE("phase 2 : Hide the marker");
